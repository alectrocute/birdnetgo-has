#!/bin/bash
# version 1.0
# BirdNET-Go Video Generator (Legacy Search)
# Builds a shareable MP4 from legacy audio downloads
# (filenames like <scientific_name>_<confidence>_<timestamp>.m4a from the
# /api/v1/media/audio endpoint).
#
# Requires: curl, jq, ffmpeg, awk
# Requires a labels file next to this script to translate scientific names to
# common names. Download BirdNET_GLOBAL_6K_V2.4_Labels_en_us.txt from:
# https://github.com/birdnet-team/BirdNET-Analyzer/tree/v2.0.0/birdnet_analyzer/labels/V2.4
